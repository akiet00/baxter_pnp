...
from baxter_builder.srv import * #import ObjLocation object
...
def callback(message):
    ...
    if obj_color == 0:
        ...
        if numobj > 0:
            ...
            #print "Found green ", numobj,  "object(s)object_location_service"
            obj_found = True
        else:
...
Subscribes to right hand camera image feed
'''
def main():

    #Initiate right hand camera object detection node
    rospy.init_node('right_camera_node')
    rospy.loginfo("Initilizing right_camera_node")
    ...
    # print "right - Ready to find object."
